...
COMMANDS: list[tuple[str, str, str | None, str]] = [
    ...
    # Invites
    ("invite",              "Send your server\'s invite link during a call.",          "/invite",                        "invite"),
    ("invite send",         "Send your server\'s invite to the other side of a call.", "/invite send",                   "invite"),
    ("invite status",       "Check this server\'s daily invite quota and XP balance.", "/invite status",                 "invite"),
    ("invite buy",          "Buy extra invite quota with server XP. (Manage Messages)", "/invite buy <5|10|20>",          "invite"),
    # Callboard
